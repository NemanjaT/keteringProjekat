<%-- 
    Document   : dodajMeni
    Created on : Sep 5, 2022, 6:04:08 PM
    Author     : Nemanja
--%>
...
<%
		Keteringsluzba sluzba = (Keteringsluzba) request.getAttribute("sluzba");
                %>
    <div class="container px-5">
<form id="registracija" method="post" action="DodajMeni">
    <h3 class="page-header page-section-heading text-center text-uppercase text-secondary mb-0">Dodaj meni</h3>
        <div class="form-group row py-1">
                ...
                <div class="col-sm-6">
                        <input type="text" class="form-control" id="colFormLabel"
                                name="meniID"
                                value="<%=request.getAttribute("novMeniID")%>" readonly>
        ...
        <div class="form-group row py-1">
          ...
          <div class="form-group row py-1">
                ...
                <div class="col-sm-6">
                        <input type="text" class="form-control" id="colFormLabel"
                               name="ketSluzbaID" value="<%=sluzba.getKetSluzbaID()%>" readonly>
                </div>
                <div class="col-sm-2"></div>
        </div>
