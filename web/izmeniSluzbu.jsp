<%-- 
    Document   : izmeniSluzbu
    Created on : Sep 5, 2022, 2:47:24 PM
    Author     : Nemanja
--%>
...
<div class="container px-5">
		...
		<form id="registracija" method="post" action="IzmeniSluzbu">
                    <h3 class="page-header page-section-heading text-center text-uppercase text-secondary mb-0">Izmeni sluzbu</h3>
			<div class="form-group row py-1">
				<div class="col-sm-2"></div>
				<label for="colFormLabel" class="col-sm-2 col-form-label">ID
					Ketering Sluzbe</label>
				<div class="col-sm-6">
					<input type="number" class="form-control" id="colFormLabel"
						name="ketSluzbaID"
						value="<%= sluzba.getKetSluzbaID() %>" readonly>
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="naziv" value="<%=sluzba.getNaziv()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="adresa" value="<%=sluzba.getAdresa()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="telefon" value="<%=sluzba.getTelefon()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="slikaUrl" value="<%=sluzba.getSlikaUrl()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			...
			<div class="form-group row">
			   <div class="col-sm-2"> </div>
				<div class="col-sm-8">
					<input type="submit" class="form-control btn btn-primary" id="colFormLabel" value="UNESI">
				</div>
				<div class="col-sm-2"></div>
			</div>
