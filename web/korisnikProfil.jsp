<%-- 
    Document   : korisnikProfil
    Created on : Sep 7, 2022, 1:02:50 PM
    Author     : Nemanja
--%>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">ID Ketering sluzbe</th>
                                ...
                                <%
                                    for(Porudzbina porudzbina : porudzbine){
                                     ...
                                     <tr>
                                         ...
                                         <td><%= porudzbina.getUkupnaCena() %></td>
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-10">
                                    <h3>Trenutno nemate porudzbina</h3>
                                    <a href="Pocetna">Pogledajte ponudu i zakazite uslugu</a>
                                </div>
                                <div class="col-md-1"></div>
                            </div>
                            <% } %>
