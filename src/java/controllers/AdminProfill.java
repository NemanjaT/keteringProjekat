 ...
 * @author Nemanja
 */
public class AdminProfill extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesija.getAttribute("rola") != null){
            if(sesija.getAttribute("rola").toString().matches("Admin")){
                ...
                try{
                    sluzbaDB.connect();
                    List<Keteringsluzba> sluzbe = sluzbaDB.uzmiSve();
                    List<Korisnik> korisnici = korisnikDB.vratiSveKorisnike();
                    List<Menadzer> menadzeri = menadzerDB.uzmiSveMenadzere();
                    
                    request.setAttribute("sluzbe", sluzbe);
             ...
             RequestDispatcher dispatcher = request.getRequestDispatcher("adminStrana.jsp");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminProfil</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminProfil at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
