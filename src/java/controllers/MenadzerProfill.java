 ...
 * @author Nemanja
 */
public class MenadzerProfill extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesija.getAttribute("rola") != null){
            if (sesija.getAttribute("rola").toString().matches("Menadzer")){
                menadzer = menadzerDB.uzmiMenadzera(sesija.getAttribute("user").toString());
                sluzba = sluzbaDB.uzmiSluzbu(String.valueOf(menadzer.getKetSluzbaID()));
                porudzbine = porudzbinaDB.uzmiPoSluzbi(sluzba);
                meniji = meniDB.uzmiPoSluzbi(sluzba);
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("pocetnaMenadzer.jsp");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MenadzerProfil</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MenadzerProfil at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
