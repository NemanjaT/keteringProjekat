<%-- 
    Document   : dodajMenadzera
    Created on : Sep 4, 2022, 7:53:33 PM
    Author     : Nemanja
--%>
...
<div class="container px-5">
			<form id="registracija" method="post" action="DodajMenadzera">
                            <h3 class="page-header page-section-heading text-center text-uppercase text-secondary mb-0">Dodaj menadzera</h3>
			...
			<div class="form-group row py-1">
				<div class="col-sm-2"></div>
				<label for="colFormLabel" class="col-sm-2 col-form-label">Ketering Sluzba</label>
				<div class="col-sm-6">
					<select class="form-control" id="colFormLabel" name="ketSluzbaID">
						<option selected value="none">Odaberite Ketering Sluzbu</option>
						<%if(sluzbe != null){ %>
