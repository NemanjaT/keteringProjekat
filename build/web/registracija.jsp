<%-- 
    ...
    Created on : Sep 1, 2022, 11:50:11 PM
    Author     : Nemanja
--%>
...
<div class="container px-5">
    ...
    <form id="registracija" method="post" action="Registration">
        <h2 class="page-header page-section-heading text-center text-uppercase text-secondary mb-0">Registruj se</h2>
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="labels" class="col-sm-2 col-form-label">Username</label>
				<div class="col-sm-6">
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="labels" class="col-sm-2 col-form-label">Ime i Prezime</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="imePrezime">
				</div>
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="labels" class="col-sm-2 col-form-label">Kontakt telefon</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="brTel">
				</div>
				<div class="col-sm-2"></div>
                        ...
                        <div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="labels" class="col-sm-2 col-form-label">Adresa stanovanja</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="adresa">
				</div>
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="labels" class="col-sm-2 col-form-label">Password</label>
				<div class="col-sm-6">
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="labels" class="col-sm-2 col-form-label">Potvrdite password</label>
				<div class="col-sm-6">
					<input type="password" class="form-control" id="colFormLabel"
						name="passConf">
				</div>
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<div class="col-sm-8">
					<input type="submit" class="form-control btn btn-success" id="colFormLabel" value="Registruj se">
				</div>
				<div class="col-sm-2"></div>
			</div>
		</form>
