<%-- 
    Document   : dodajSluzbu
    Created on : Sep 4, 2022, 5:44:37 PM
    Author     : Nemanja
--%>
...
<div class="container px-5">
<form id="registracija" method="post" action="DodajSluzbu">
    <h3 class="page-header page-section-heading text-center text-uppercase text-secondary mb-0">Dodaj sluzbu</h3>
        <div class="form-group row py-1">
                <div class="col-sm-2"></div>
                <label for="colFormLabel" class="col-sm-2 col-form-label">ID Sluzbe</label>
                <div class="col-sm-6">
                        <input type="text" class="form-control" id="colFormLabel"
                                name="ketSluzbaID"
                                value="<%=request.getAttribute("novaSluzbaID")%>" readonly>
