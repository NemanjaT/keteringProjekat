<%-- 
    ...
    Created on : Sep 5, 2022, 12:29:32 AM
    Author     : Nemanja
--%>
...
<div class="container px-5">
		...
		<form id="registracija" method="post" action="IzmeniKorisnika">
                    <h3 class="page-header page-section-heading text-center text-uppercase text-secondary mb-0">Izmeni korisnika</h3>
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<label for="colFormLabel" class="col-sm-2 col-form-label">Username</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="korisnickoIme" value="<%=korisnik.getUsername()%>" disabled>
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
			   ...
			   <div class="col-sm-2"> </div>
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="colFormLabel"
						name="adresa" value="<%=korisnik.getAdresa()%>">
				</div>
				<div class="col-sm-2"></div>
			</div>
			<div class="form-group row py-1">
			...
			<div class="form-group row py-1">
			   <div class="col-sm-2"> </div>
				<div class="col-sm-8">
					<input type="submit" class="form-control btn btn-primary" id="colFormLabel" value="Izmeni">
				</div>
				<div class="col-sm-2"></div>
			</div>
		</form>
